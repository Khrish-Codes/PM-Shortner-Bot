...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="https://t.me/SpidyRockss")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            ...
            InlineKeyboardButton('Owner', url="https://https://t.me/SpidyRockss")
        ],[
            InlineKeyboardButton('Use Me Here', url=f'https://t.me/MOVIES_HUB_ALPHA_SEARCH_GROUP')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
