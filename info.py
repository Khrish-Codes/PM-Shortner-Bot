...
BOT_TOKEN = environ.get('BOT_TOKEN', "6384094059:AAFh7NDylEnzHvPeqPGMJNIFA3Js6cy1Q20")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6408116706').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+QmbtS895r485MmI1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+vp-LqpC02tlkYWNl')
TUTORIAL = environ.get('TUTORIAL', '0')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '@wegdasdvasdxvSZDgfsDzgfvcSDZxfcS'))
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"<code>{script.CAPTION}</code>\n\n<b>━━━━━━━━━━•••••━━━━━━━━━\n🏘 Backup - @MOVIES_HUB_ALPHA_official\n❤️ SHARE AND SUPPORT US</b>")
